...
profile_warmup, mp_warmup = initialize_profile(mp_warmup, cf_warmup; depth_autoadjust=false)
...
@profile begin
    ...
    profile, mp = initialize_profile(mp, cf; depth_autoadjust=false)
...
profile_spinup, mp_spinup_prof = initialize_profile(mp_spinup_prof, cf_spinup; depth_autoadjust=false)
